...
export const appRouter = router({
  ...
  crm: router({
    ...
    getSegments: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.customerSegments)
          .where(eq(schema.customerSegments.tenantId, input.tenantId));
      }),
    ...
    addCustomersToSegment: publicProcedure
      .input(z.object({
        segmentId: z.number(),
    ...
    getCampaigns: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.marketingCampaigns)
          .where(eq(schema.marketingCampaigns.tenantId, input.tenantId))
    ...
    // Referral Program
    getReferralProgram: publicProcedure
      .input(z.object({ tenantId: z.string() }))
      .query(async ({ input }) => {
        const [program] = await db.select().from(schema.referralProgram)
          .where(eq(schema.referralProgram.tenantId, input.tenantId));
        return program;
      }),

    updateReferralProgram: publicProcedure
      .input(z.object({
        tenantId: z.string(),
        isActive: z.boolean(),
    ...
    getReferrals: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.referrals)
          .where(eq(schema.referrals.tenantId, input.tenantId))
          .orderBy(desc(schema.referrals.createdAt));
      }),

    // Gift Cards
    getGiftCards: publicProcedure
      .input(z.object({ tenantId: z.string() }))
      .query(async ({ input }) => {
        return await db.select().from(schema.giftCards)
          .where(eq(schema.giftCards.tenantId, input.tenantId))
    ...
    getPromoCodes: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.promoCodes)
          .where(eq(schema.promoCodes.tenantId, input.tenantId))
    ...
    getFeedback: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.customerFeedback)
          .where(eq(schema.customerFeedback.tenantId, input.tenantId))
    ...
    // NPS Surveys
    getNPSSurveys: publicProcedure
      .input(z.object({ tenantId: z.string() }))
      .query(async ({ input }) => {
        const surveys = await db.select().from(schema.npsSurveys)
          .where(eq(schema.npsSurveys.tenantId, input.tenantId));
    ...
    createNPSSurvey: publicProcedure
      .input(z.object({
        tenantId: z.string(),
        customerId: z.number(),
    ...
    getItems: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.inventoryItems)
          .where(eq(schema.inventoryItems.tenantId, input.tenantId))
    ...
    getSuppliers: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.suppliers)
          .where(eq(schema.suppliers.tenantId, input.tenantId))
    ...
    getPurchaseOrders: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.purchaseOrders)
          .where(eq(schema.purchaseOrders.tenantId, input.tenantId))
    ...
    getRules: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.commissionRules)
          .where(eq(schema.commissionRules.tenantId, input.tenantId))
    ...
    getCommissions: publicProcedure
      ...
      .query(async ({ input }) => {
        let query = db.select().from(schema.commissions)
          .where(eq(schema.commissions.tenantId, input.tenantId));
    ...
    getTargets: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.commissionTargets)
          .where(eq(schema.commissionTargets.tenantId, input.tenantId))
    ...
    getPayouts: publicProcedure
      ...
      .query(async ({ input }) => {
        return await db.select().from(schema.commissionPayouts)
          .where(eq(schema.commissionPayouts.tenantId, input.tenantId))
  ...
  customerPortal: router({
    ...
    // Favorites
    getFavoriteServices: publicProcedure
    ...
    addFavoriteService: publicProcedure
      .input(z.object({
        customerId: z.number(),
        serviceId: z.number(),
      }))
    ...
    getFavoriteEmployees: publicProcedure
      .input(z.object({ customerId: z.number() }))
      .query(async ({ input }) => {
    ...
    addFavoriteEmployee: publicProcedure
      .input(z.object({
        customerId: z.number(),
        employeeId: z.number(),
    ...
    // Loyalty Points
    getLoyaltyPoints: publicProcedure
      .input(z.object({ customerId: z.number() }))
      .query(async ({ input }) => {
