...
export const tenants = mysqlTable("tenants", {
  ...
  // Email Limits & Subscription
  subscriptionPlan: varchar("subscriptionPlan", { length: 20 }).default("basic"),
  emailMonthlyLimit: int("emailMonthlyLimit").default(500),
  emailsSentThisMonth: int("emailsSentThisMonth").default(0),
  emailOverageRate: decimal("emailOverageRate", { precision: 10, scale: 2 }).default("0.10"),
  currentMonthStart: date("currentMonthStart"),
  emailOverageCharge: decimal("emailOverageCharge", { precision: 10, scale: 2 }).default("0.00"),
  // Stripe Integration
  stripeCustomerId: varchar("stripeCustomerId", { length: 255 }),
  // SMS Package
  smsPackageSize: int("smsPackageSize").default(0),
  smsPackagePrice: decimal("smsPackagePrice", { precision: 10, scale: 2 }).default("0.00"),
  smsSentThisMonth: int("smsSentThisMonth").default(0),
  smsOverageRate: decimal("smsOverageRate", { precision: 10, scale: 2 }).default("1.00"),
  smsOverageCharge: decimal("smsOverageCharge", { precision: 10, scale: 2 }).default("0.00"),
  smsPackageActive: boolean("smsPackageActive").default(false),
...
// ============================================================================
// EMAIL LIMITS & SUBSCRIPTION PLANS
// ============================================================================

export const subscriptionPlans = mysqlTable("subscription_plans", {
  id: int("id").autoincrement().primaryKey(),
  planName: varchar("planName", { length: 20 }).notNull().unique(),
  displayName: varchar("displayName", { length: 100 }).notNull(),
  emailMonthlyLimit: int("emailMonthlyLimit").notNull(),
  emailOverageRate: decimal("emailOverageRate", { precision: 10, scale: 2 }).notNull(),
...
export const emailUsageLogs = mysqlTable("email_usage_logs", {
  id: int("id").autoincrement().primaryKey(),
  tenantId: varchar("tenantId", { length: 36 }).notNull(),
  ...
  isOverage: boolean("isOverage").default(false),
  overageCost: decimal("overageCost", { precision: 10, scale: 2 }).default("0.00"),
}, (table) => ({
  tenantDateIdx: index("tenant_date_idx").on(table.tenantId, table.sentAt),
  tenantMonthIdx: index("tenant_month_idx").on(table.tenantId, table.sentAt),
}));

export type SubscriptionPlan = typeof subscriptionPlans.$inferSelect;
export type InsertSubscriptionPlan = typeof subscriptionPlans.$inferInsert;

export type EmailUsageLog = typeof emailUsageLogs.$inferSelect;
export type InsertEmailUsageLog = typeof emailUsageLogs.$inferInsert;


export const emailOverageInvoices = mysqlTable("email_overage_invoices", {
  id: int("id").autoincrement().primaryKey(),
  tenantId: varchar("tenantId", { length: 36 }).notNull(),
  invoiceNumber: varchar("invoiceNumber", { length: 50 }).notNull().unique(),
  billingPeriodStart: date("billingPeriodStart").notNull(),
  billingPeriodEnd: date("billingPeriodEnd").notNull(),
  emailsOverLimit: int("emailsOverLimit").notNull().default(0),
  overageRate: decimal("overageRate", { precision: 10, scale: 2 }).notNull(),
  ...
  billingPeriodIdx: index("billing_period_idx").on(table.tenantId, table.billingPeriodStart, table.billingPeriodEnd),
  stripeInvoiceIdx: index("stripe_invoice_idx").on(table.stripeInvoiceId),
}));

export type EmailOverageInvoice = typeof emailOverageInvoices.$inferSelect;
export type InsertEmailOverageInvoice = typeof emailOverageInvoices.$inferInsert;
...
export const smsPackages = mysqlTable("sms_packages", {
  id: int("id").autoincrement().primaryKey(),
  packageSize: int("packageSize").notNull().unique(),
  pricePerSms: decimal("pricePerSms", { precision: 10, scale: 2 }).notNull(),
  monthlyPrice: decimal("monthlyPrice", { precision: 10, scale: 2 }).notNull(),
  displayName: varchar("displayName", { length: 100 }).notNull(),
  isActive: boolean("isActive").default(true),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
...
export const smsUsageLogs = mysqlTable("sms_usage_logs", {
  id: int("id").autoincrement().primaryKey(),
  tenantId: varchar("tenantId", { length: 36 }).notNull(),
  smsType: varchar("smsType", { length: 50 }).notNull(),
...
export const smsOverageInvoices = mysqlTable("sms_overage_invoices", {
  id: int("id").autoincrement().primaryKey(),
  tenantId: varchar("tenantId", { length: 36 }).notNull(),
  invoiceNumber: varchar("invoiceNumber", { length: 50 }).notNull().unique(),
  billingPeriodStart: date("billingPeriodStart").notNull(),
  billingPeriodEnd: date("billingPeriodEnd").notNull(),
  smsOverLimit: int("smsOverLimit").notNull().default(0),
  overageRate: decimal("overageRate", { precision: 10, scale: 2 }).notNull(),
  packageCharge: decimal("packageCharge", { precision: 10, scale: 2 }).notNull().default("0.00"),
  overageCharge: decimal("overageCharge", { precision: 10, scale: 2 }).notNull().default("0.00"),
  subtotal: decimal("subtotal", { precision: 10, scale: 2 }).notNull(),
  vatRate: decimal("vatRate", { precision: 5, scale: 2 }).notNull().default("25.00"),
  vatAmount: decimal("vatAmount", { precision: 10, scale: 2 }).notNull(),
  totalAmount: decimal("totalAmount", { precision: 10, scale: 2 }).notNull(),
...
export type SmsPackage = typeof smsPackages.$inferSelect;
export type InsertSmsPackage = typeof smsPackages.$inferInsert;

export type SmsUsageLog = typeof smsUsageLogs.$inferSelect;
export type InsertSmsUsageLog = typeof smsUsageLogs.$inferInsert;

export type SmsOverageInvoice = typeof smsOverageInvoices.$inferSelect;
export type InsertSmsOverageInvoice = typeof smsOverageInvoices.$inferInsert;
